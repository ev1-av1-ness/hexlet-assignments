...
class AppTest {
    ...
    void testBuildApartmentsList1() {
        ...
        List<String> result = App.buildAppartmentsList(apartments, 3);
    ...
    void testBuildApartmentsList2() {
        ...
        List<String> result = App.buildAppartmentsList(apartments, 4);
        assertThat(result).isEqualTo(expected);
    ...
    void testBuildApartmentsList3() {
        ...
        List<String> result = App.buildAppartmentsList(apartments, 10);
        assertThat(result).isEqualTo(expected);
    }

    // BEGIN
    @Test
    void testNonEmptyCharSequence() {
